...
const Component = () => {
  ...
  //== ***** ***** ***** Component Return ***** ***** ***** ==//
  //-- If status is changing, show "Updating..." skeleton --//
  if (AccountContext.clickwrapStatusChanging) {
    return (
      <div className="flex h-32 w-full animate-pulse items-center justify-center rounded-lg bg-zinc-200 dark:bg-zinc-700">
