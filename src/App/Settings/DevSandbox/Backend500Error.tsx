...
const ComponentWithError = () => {
  ...
  const throwErrorHandler = () => {
    try {
      // TODO - send request to an express route that returns a 500 error
      throw new Error("hello, this is an example of a backend 500 error");
    } catch (err) {
      showBoundary(err);
    }
  };
...
const Fallback = () => {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-2 rounded-md bg-orange-200 p-2">
      ...
      {/* TODO  */}
      <p className="text-md font-mono">TODO - error message or info</p>
