...
export default function AppLayout() {
  ...
  return (
    <div className="flex h-full overflow-auto bg-zinc-50 dark:bg-zinc-700">
      ...
      <div id="spacer" className="md:w-64" />
      <div className="fixed hidden h-full bg-zinc-200 dark:bg-zinc-800 md:block md:w-64">
        {/* START OF CHRT LOGO */}
        <div className="flex h-16 items-center bg-zinc-300 px-4 dark:bg-zinc-900">
          <a
            href={window.location.origin}
      ...
      {/* START OF RHS */}
      <div className="">
        {/* START OF MOBILE SIDEBAR HAMBURGER BUTTON */}
        <button
          type="button"
        ...
        {/* END OF MOBILE SIDEBAR HAMBURGER BUTTON */}

        {/* START OF SEARCH BAR + PROFILE DROPDOWN MENU*/}
        <div className="sticky top-0 flex h-16 flex-shrink-0 flex-col justify-between bg-white px-4 shadow dark:bg-zinc-800">
          {/* START OF SEARCH BAR */}
          ...
          {/* END OF SEARCH BAR */}
          {/* START OF PROFILE DROPDOWN MENU */}
        ...
        {/* END OF SEARCH BAR + PROFILE DROPDOWN MENU*/}
